...
\cliente{Grupo de Investigación y Desarrollo en Aplicaciones Inteligentes}
\empresaCliente{Universidad Tecnológica Nacional Facultad Regional San Francisco}
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el prototipo preliminar de un sistema embebido para el control de un Titulador Potenciométrico Automático, y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y \$50.000, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
